...
.controller('mmFilesAsignaturasCtrl', function($scope, $stateParams, mmFilesSite) {
    var path = $stateParams.path,
        files = mmFilesSite.getFiles(path);
...
.controller('mmFilesAlumnosCtrl', function($scope, $stateParams, mmFilesSite) {
    var path = $stateParams.path,
        files = mmFilesSite.getFiles(path);
...
.controller('mmFilesLenguasCtrl', function($scope, $stateParams, mmFilesSite) {
    var path = $stateParams.path,
        files = mmFilesSite.getFiles(path);
...
.controller('mmFilesTutoriasCtrl', function($scope, $stateParams, mmFilesSite) {
    var path = $stateParams.path,
        files = mmFilesSite.getFiles(path);
...
.controller('mmFilesAntCtrl', function($scope, $stateParams, mmFilesSite) {
    var path = $stateParams.path,
        files = mmFilesSite.getFiles(path);
...
.controller('mmFilesCursoCtrl', function($scope, $stateParams, mmFilesSite) {
    var path = $stateParams.path,
        files = mmFilesSite.getFiles(path);
...
.controller('mmFilesSystemCtrl', function($scope, $stateParams, mmFilesSite) {
    var path = $stateParams.path,
        files = mmFilesSite.getFiles(path);
